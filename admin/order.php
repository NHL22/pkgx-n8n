...
elseif ($_REQUEST['act'] == 'info')
{
    ...
    $goods_list = array();
    $goods_attr = array();
    $sql = "SELECT o.*, IF(o.product_id > 0, p.product_number, g.goods_number) AS storage, o.goods_attr, g.suppliers_id, g.partner_price, g.deal_price, IFNULL(b.brand_name, '') AS brand_name, p.product_sn
...
elseif ($_REQUEST['act'] == 'json')
{
    ...
    if ($func == 'get_goods_info')
    {
        ...
        $sql = "SELECT goods_id, c.cat_name, goods_sn, goods_name, b.brand_name, " .
            "goods_number, market_price, partner_price, shop_price, promote_price, " .
