...
//$modules['04_order']['15_alepay']                   = 'alepay.php?act=list';
...
$modules['11_system']['09_linkzalo_list']         = 'linkzalo.php?act=list';
...
$modules['11_system']['slug_manage']                = 'slug.php?act=list';
$modules['11_system']['ckfinder_manage']            = 'files_manage.php';
$modules['11_system']['redirect_manage']            = 'redirect.php?act=list';
...
// $modules['14_sms']['02_sms_history']                = 'sms.php?act=list';
// $modules['14_sms']['03_sms_send']                   = 'sms.php?act=add';
