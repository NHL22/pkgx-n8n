 ...
 * @param string $height
 */
function CKeditor($input_name, $input_value = '',$toolbar_type = 'Full', $width = '100%', $height= '350')
{
    global $smarty;

    $ckeditor = "<textarea rows='16' style='width:100%'  name='$input_name' id='editor_$input_name'>$input_value</textarea>
    <script type='text/javascript'>
            var editor = CKEDITOR.replace( 'editor_$input_name', {
                width: '$width',
                height: '$height',
