...
elseif ($_REQUEST['act'] == 'act_export_google')
{

}
elseif ($_REQUEST['act'] == 'act_export_facebook')
{
...
elseif($_REQUEST['act'] == 'act_export_ecshop')
{
    ...
    $goods_value['brand_id'] = '""';
    $goods_value['brand_name'] = '""';
    $goods_value['shop_price'] = 0;
    $goods_value['deal_price'] = 0;
    $goods_value['partner_price'] = 0;
    $goods_value['is_promote'] = 0;
    $goods_value['promote_price'] = 0;
    $goods_value['promote_start_date'] = 0;
    $goods_value['promote_end_date'] = 0;
    $goods_value['goods_img'] = '""';
    $goods_value['goods_link'] = '""';
    $goods_value['keywords'] = '""';
    $goods_value['seller_note'] = '';
    $goods_value['meta_title'] = '';
    $goods_value['meta_desc'] = '';

    $goods_value['goods_number'] = 0;
    $goods_value['is_best'] = 0;
    $goods_value['is_new'] = 0;
    $goods_value['is_hot'] = 0;
    $goods_value['is_home'] = 0;
    ...
    while ($row = $db->fetchRow($res))
    {
        ...
        $goods_value['brand_id'] = '"' . $row['brand_id'] . '"';
        $goods_value['brand_name'] = '"' . $row['brandname'] . '"';
        $goods_value['shop_price'] = $row['shop_price'];
        $goods_value['deal_price'] = $row['deal_price'];
        $goods_value['partner_price'] = $row['partner_price'];
        $goods_value['is_promote'] = $row['is_promote'];
        $goods_value['promote_price'] = $row['promote_price'];
        $goods_value['promote_start_date'] = date('Y-m-d H:i:s',$row['promote_start_date']);
        $goods_value['promote_end_date'] = date('Y-m-d H:i:s',$row['promote_end_date']);
        $goods_value['goods_img'] = '"' .$base_cdn. $row['goods_img'] . '"';
        $goods_value['goods_link'] = '"'. $ecsvn_request['getBaseUrl'] . build_uri('goods', array('gid' => $row['goods_id'])) . '"';
        $goods_value['keywords'] = '"' . $row['keywords'] . '"';
         $goods_value['seller_note'] = '"' . replace_special_char($row['seller_note'], false) . '"';
        $goods_value['meta_title'] = '"' . replace_special_char($row['meta_title'], false) . '"';
        $goods_value['meta_desc'] = '"' . replace_special_char($row['meta_desc'], false) . '"';
        ...
        $goods_value['is_home'] = $row['is_home'];
    ...
    //$content = chr(255).chr(254).iconv("UTF-8", "UTF-16LE//IGNORE", $content);
    $zip->add_file("\xEF\xBB\xBF".$content, 'goods_list.csv');
...
elseif ($_REQUEST['act'] == 'act_export_custom')
{
    ...
    while ($row = $db->fetchRow($res))
    {
        ...
        isset($goods_value['is_home']) && ($goods_value['is_home'] = $row['is_home']);
        isset($goods_value['deal_price']) && ($goods_value['deal_price'] = $row['deal_price']);
        isset($goods_value['partner_price']) && ($goods_value['partner_price'] = $row['partner_price']);
        isset($goods_value['seller_note']) && ($goods_value['seller_note'] = $row['seller_note']);
        isset($goods_value['meta_title']) && ($goods_value['meta_title'] = $row['meta_title']);
        isset($goods_value['meta_desc']) && ($goods_value['meta_desc'] = $row['meta_desc']);
