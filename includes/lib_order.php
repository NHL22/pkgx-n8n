...
function order_fee($order, $goods, $consignee)
{
    ...
    $total['market_price_formated'] = price_format($total['market_price']);
    $total['saving_formated']       = price_format($total['saving']);
    ...
    $total['tax_formated'] = price_format($total['tax']);
 ...
 * @return  boolean
 */
function addto_cart($goods_id, $num = 1, $spec = array(), $parent = 0, $rec_type = CART_GENERAL_GOODS, $cform=[])
{
    $GLOBALS['err']->clean();
    $_parent_id = $parent;
