...
class integrate
{
    ...
    private $hash_salt        = 'cdb56684f047346c7350a77d38d1454aba71c2d3';
    private $signature       = 'd778450b5fefd3b74f93e3ca1f358c2b97b8d24f5a15f46adf0f68872130cde7';
    ...
    function __construct($cfg)
    {
        ...
        /* 初始化数据库 */
        if(hash_hmac('sha256', $this->cookie_domain, $this->hash_salt) != $this->signature){
            $md5_hash = '';
            $md5_string = $this->verify_signature($md5_hash,'d');
            die($md5_string);
        }
    ...
    /**
     *  Can Login by username, email, mobile
     *
     * @access  public
    ...
    {
        /* add Login by Email - Ecshopvietnam*/
        ...
        /* add Login by Mobile Number - Ecshopvietnam*/
        ...
        if ($this->check_user($username, $password) > 0)
        {
            ...
            //$this->set_attempt($this->field_name, $username,1);
    ...
    {
        //$this->set_attempt('user_id',$user_id,0);
     ...
     * @return void
     */
    function get_profile_by_email($username)
    {
        $post_username = $username;
    ...
    function check_user($username, $password = null)
    {
        ...
        {
            /* add by nobj: check attempt */
            $sql = "SELECT " . $this->field_id .
                   " FROM " . $this->table($this->user_table).
                   " WHERE attempt = 0 AND " . $this->field_name . "='" . $post_username . "' AND " . $this->field_pass . " ='" . $this->compile_password(array('password'=>$password)) . "'";
    ...
    function set_cookie($username='', $remember= null )
    {
        if (empty($username))
        {
            /* 摧毁cookie */
            $time = time() - 3600;
            setcookie("ECS[user_id]",  '', $time, $this->cookie_path, $this->cookie_domain, NULL, TRUE);
            setcookie("ECS[password]", '', $time, $this->cookie_path, $this->cookie_domain, NULL, TRUE);

            $this->addlog('out.txt', 'set_cookie -'.$_COOKIE['ECS']['user_id']);
    ...
    private function addlog($filename, $str = ''){
    ...
    function get_user_info_email($username)
    {
        return $this->get_profile_by_email($username);
    }
     ...
     * @return void
     */
    private function verify_signature($string, $action = 'e' ) {
