...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    /* noindex params: page */
    if($ecsvn_index_follow == false || isset($_GET['client']) || isset($_GET['fb_comment_id']))
    {
    ...
    $smarty->assign('best_goods',      get_recommend_goods('best', 'home'));    // 推荐商品
    $smarty->assign('new_goods',       get_recommend_goods('new', 'home'));     // 最新商品
    $smarty->assign('hot_goods',       get_recommend_goods('hot', 'home'));     // 热点文章
