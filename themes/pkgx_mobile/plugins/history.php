...
function siy_history($atts) {
	...
	if (!empty($_COOKIE['ECS']['history'])) {
		...
		$sql   = 'SELECT goods_id, goods_name, goods_thumb, deal_price,goods_number, partner_price, shop_price,is_hot , promote_price, promote_start_date, promote_end_date FROM ' . $GLOBALS['ecs']->table('goods') .
